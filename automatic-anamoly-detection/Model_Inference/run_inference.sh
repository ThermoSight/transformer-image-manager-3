...
if [[ ! -d "$VENV_PATH" ]]; then
  ...
  echo "        Example: VENV='/mnt/c/Users/HP/Desktop/Sem 7/Software Design Competition/transformer-image-manager-3/automatic-anamoly-detection/.venv' ./run_inference.sh" >&2
  exit 1
fi
